...
static rt_err_t rt_stm32_eth_control(rt_device_t dev, rt_uint8_t cmd, void *args)
{
    ...
    case CHKLINK_IOCTL_GADDR:
    {
        ...
        link_status = ETH_ReadPHYRegister(0, PHY_BSR);
        link_status = (link_status & 0x04) >> 2;
        if (link_status != stm32_eth_device.parent.link_status)
        {
            stm32_eth_device.parent.link_changed = 1;
        }
        stm32_eth_device.parent.link_status = link_status;
        
        /* leave interrupt */
        rt_hw_interrupt_enable(level);
//        stm32_eth_device.parent.link_status = 1;
        break;
    }
    default :
        break;
 ...
 * GPIO Configuration for ETH
    ...
    *******************************************
    ...
    - ETH_MII_RXD3: PD12
 */
static void rt_hw_delay_ms(uint16_t time)
{   
...
static void GPIO_Configuration(void)
{
    ...
    /* Configure ETH_Reset (PD3) as Out_PP function push-pull */
    GPIO_InitStructure.GPIO_Pin = GPIO_Pin_3;
    GPIO_InitStructure.GPIO_Speed = GPIO_Speed_2MHz;
    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP;
    GPIO_Init(GPIOD, &GPIO_InitStructure);
    /* Configure GPIO low to reset phy */
